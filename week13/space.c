...
unsigned char byte_small_buf_mask = 0; // 0 0 0 0 0 0 0 0
...
void our_malloc(int type, void **target, int *mem_location) // *target = tQueueSmall
{
    int location;
    ...
    {
        location = test_single_location(byte_small_buf_mask, 1);
        set_single_bit(.............);
        *target = .............. ;
